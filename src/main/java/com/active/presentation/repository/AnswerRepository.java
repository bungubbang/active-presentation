...
public interface AnswerRepository extends JpaRepository<Answer, Long> , JpaSpecificationExecutor<Answer> {
    ...
    @Query("SELECT new com.active.presentation.repository.dto.AnswerResultDto(a.resultId as id, a.result as result, count(a.result) as choice, a.createdDate as createdDate, d.status as status) FROM Answer a JOIN a.dashboard d WHERE a.dashboard = :dashboard GROUP BY a.result")
    ...
    @Query("SELECT new com.active.presentation.repository.dto.AnswerResultDto(a.resultId as id, a.result as result, d.title as title, a.createdDate as createdDate, d.status as status) FROM Answer a join a.dashboard d join d.speaker s " +
